...
XEND_ERROR_UUID_INVALID         = ['UUID_INVALID']
#XEND_ERROR_HANDLE_INVALID       = ['HANDLE_INVALID']
XEND_ERROR_HOST_IS_SLAVE        = ['HOST_IS_SLAVE']

XEND_API_ERROR_VM_IS_TEMPLATE = ['VM_IS_TEMPLATE']
XEND_API_ERROR_VM_UNIQUE_NAME_ERROR = ['UNIQUE_NAME_ERROR']
XEND_API_ERROR_VM_UNIQUE_UUID_ERROR = ['UNIQUE_UUID_ERROR']

XEND_ERROR_VM_BAD_POWER_STATE   = 'VM_BAD_POWER_STATE'
XEND_ERROR_OPERATION_NOT_ALLOWED = 'OPERATION_NOT_ALLOWED'  