...
XEN_API_VBD_TYPE = ['CD', 'Disk', 'Fiber']
XEN_API_TASK_STATUS_TYPE = ['pending', 'success', 'failure']
XEN_API_CONSOLE_PROTOCOL = ['vt100', 'rfb', 'rdp']
VBD_DEFAULT_DEVICE = ['hda', 'hdb', 'hdc', 'hdd', 'hde', 'hdf', 'hdg', 'hdh', 'hdi', 'hdj']
VBD_XEN_DEFAULT_DEVICE = ['xvda', 'xvdb', 'xvdc', 'xvdd', 'xvde', 'xvdf', 'xvdg', 'xvdh', 'xvdi', 'xvdj']
VDI_BACKUP_TYPE = ['gpfs', 'ocfs2', 'mfs']
